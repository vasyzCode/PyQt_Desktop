        ...
        with open('rez.csv', encoding="utf8") as csvfile:
            ...
            for index, row in enumerate(reader):
                if index != 0:
                    ...
                    self.tableWidget.setItem(rowPosition, 0, QtWidgets.QTableWidgetItem(row[1].split(' ')[-2]))
                    self.tableWidget.setItem(rowPosition, 1, QtWidgets.QTableWidgetItem(row[-1]))
    ...
    def search(self):
        ...
        for user in users:
            for user_name in users[user]:
                rowPosition = self.tableWidget.rowCount()
                self.tableWidget.insertRow(rowPosition)
                self.tableWidget.setItem(rowPosition, 0, QtWidgets.QTableWidgetItem(user_name))
                self.tableWidget.setItem(rowPosition, 1, QtWidgets.QTableWidgetItem(user))
